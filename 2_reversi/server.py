...
class Server(object):
    ...
    def __init__(self, p1_dir, p2_dir, delay, history, output, pace=0, camadas=0):
        """
    ...
    def run(self):
        ...
        while True:  # runs until endgame
            ...
            start = time.time()
            function_call = timer.FunctionTimer(self.player_modules[player].make_move, (board_copy, self.player_colors[player], self.camadas))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--seed', type=str, dest='seed',
                        default='123', metavar='seed',
                        help='Seed')
    
    parser.add_argument('-c', '--camadas', type=str, dest='camadas',
                        default='3', metavar='camadas',
                        help='camadas')
    ...
    s = Server(p1, p2, args.delay, args.history, args.output, args.pace, args.camadas)
    s.run()
    s.write_output()
